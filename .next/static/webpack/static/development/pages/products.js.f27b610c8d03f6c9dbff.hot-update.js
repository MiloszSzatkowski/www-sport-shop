...
function gen_HTML_for_filter_input(fields, url_params, type_, parent_type) {
  console.log("Params: ".concat(url_params, " , Items: ").concat(Object.values(fields).toString()));
  return Object.values(fields).map(function (item) {
    return "<label class=\"".concat(parent_type, "\"><input type=\"").concat(type_, "\" name=\"").concat(parent_type, "\" ").concat(url_params != null && url_params.includes(item.toLowerCase()) ? 'checked' : '', "/>\t<span>").concat(item, "</span></label>");
  }).toString().replace(/,/g, '');
}
...
//# sourceMappingURL=products.js.f27b610c8d03f6c9dbff.hot-update.js.map