...
function gen_HTML_for_filter_input(fields, url_params, type_, parent_type) {
  ...
  var item_reggexed = new RegExp("^" + item.toLowerCase() + "*", "g");
  return Object.values(fields).map(function (item) {
    return "<label class=\"".concat(parent_type, "\"><input type=\"").concat(type_, "\" name=\"").concat(parent_type, "\" ").concat(url_params != null && url_params.match(item_reggexed) ? 'checked' : '', "/>\t<span>").concat(item, "</span></label>");
  }).toString().replace(/,/g, '');
}
...
//# sourceMappingURL=products.js.a944943dffe7e51be190.hot-update.js.map