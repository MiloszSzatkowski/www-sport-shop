...
function CheckForUrl() {
  if (window.location.href.indexOf('products') === -1 || window.location.href.indexOf('details') !== -1) {
    var el_cache = document.getElementsByClassName('input')[0].children[0];

    for (var i = 0; i < 360; i++) {
      setTimeout(function () {
        el_cache.style.transform = 'rotateX(' + i + 'deg)';
        console.log(el_cache.style.transform);
      }, 10);
    }
  }
}
...
//# sourceMappingURL=index.js.577685b3ee0787f91b2f.hot-update.js.map