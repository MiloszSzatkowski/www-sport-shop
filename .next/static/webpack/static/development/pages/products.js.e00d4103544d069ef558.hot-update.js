...
function Filter_popup_more() {
  ...
  if (filter_accum !== '') {
    ...
    console.table(url_arr[0], url_arr[1], url_arr[2]);
    console.table([url_arr[1]]);
    console.table([url_arr[2]]);
    var assemble_url_var = url_arr.map(function (item) {
      return assemble_url_fun(item);
    });
...
//# sourceMappingURL=products.js.e00d4103544d069ef558.hot-update.js.map