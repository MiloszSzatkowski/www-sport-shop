...
function gen_HTML_for_filter_input(fields, url_params, type_, parent_type) {
  ...
  return Object.values(fields).map(function (item) {
    return "<label class=\"".concat(parent_type, "\"><input type=\"").concat(type_, "\" name=\"").concat(parent_type, "\" ").concat(url_params != null && url_params.match(new RegExp("(^".concat(item.toLowerCase(), "*|w").concat(item.toLowerCase(), "$)"), "g")) ? 'checked' : '', "/>\t\t\t<span>").concat(item, "</span></label>");
  }).toString().replace(/,/g, '');
}
...
//# sourceMappingURL=products.js.faf849a98828ae4d6863.hot-update.js.map