...
function filter_for_url(par_lab) {
  return filter_accum.some(function (item) {
    return item.parent_label == par_lab;
  }) ? filter_accum.filter(function (item) {
    return item.parent_label == par_lab;
  }) : false;
}
...
function Filter_popup_more() {
  ...
  if (filter_accum !== '') {
    ...
    var url_genders = filter_for_url('genders');
    var assemble_url_genders = url_genders ? "gender=&".concat(url_genders.map(function (post) {
      return 'gender=' + post.node_label + '&';
    })) : 'gender=&gender=female&gender=male';
    console.log(assemble_url_genders); // var assemble_url = assemble_url_genders
...
//# sourceMappingURL=products.js.edce8d5b7d73f5951139.hot-update.js.map